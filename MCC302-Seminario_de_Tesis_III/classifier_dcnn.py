...
dir_to_save = "outputs/dcnn/classifier/"
        ...
        for split in range(num_splits):
          ...
          for c in C:
            ...
            for alpha_val in alpha:
              ...
              cnn = Dense(1, activation="tanh", use_bias=False)(model)
...
for data_year in years:
  for city in cities:
    for metric in metrics:
      ...
      plt.grid(True)
      plt.savefig(name_dir_ + city+"/"+metric+"/dcnn/acc.png")
      plt.clf()
      plt.cla()
      plt.close()
      ...
      #plt.legend([cities[0], cities[1]])
      plt.grid(True)
      plt.savefig(name_dir_ + city+"/"+metric+"/dcnn/loss.png")
      plt.clf()
      plt.cla()
      plt.close()
      ...
      #plt.legend([cities[0], cities[1]])
      plt.grid(True)
      plt.savefig(name_dir_ + city+"/"+metric+"/dcnn/mse.png")
      plt.clf()
      plt.cla()
      plt.close()
      ...
      #plt.legend([cities[0], cities[1]])
      plt.grid(True)
      plt.savefig(name_dir_ + city+"/"+metric+"/dcnn/auc.png")
      plt.clf()
      plt.cla()
      plt.close()
