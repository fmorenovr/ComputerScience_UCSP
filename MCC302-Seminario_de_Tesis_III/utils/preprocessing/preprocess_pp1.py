...
from utils.datasets import setName

from .variables import scores_dir, ROOT_DIR

def preprocess_pp1(file_name="placepulse_1.json", scores_dir=ROOT_DIR+"pp1/Qscores/"):
  path = ROOT_DIR + "pp1/"+file_name
