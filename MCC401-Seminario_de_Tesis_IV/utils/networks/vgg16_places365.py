...
WEIGHTS_PATH = 'models/scenerecognizer/places2/vgg16/vgg16-places365_weights_tf_dim_ordering_tf_kernels.h5'
WEIGHTS_PATH_NO_TOP = 'models/scenerecognizer/places2/vgg16/vgg16-places365_weights_tf_dim_ordering_tf_kernels_notop.h5'

def VGG16_Places365(input_shape, include_top=False, weights='places', input_tensor=None, pooling=None, classes=365):
    ...
    if weights == 'places':
        if include_top:
            ...
            #weights_path = get_file('vgg16-places365_weights_tf_dim_ordering_tf_kernels_notop.h5', WEIGHTS_PATH_NO_TOP, cache_subdir='models')
