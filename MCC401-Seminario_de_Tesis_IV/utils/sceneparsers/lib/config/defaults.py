...
_C = CN()
_C.DIR = "models/sceneparser/ade20k"

# -----------------------------------------------------------------------------
# Dataset
# -----------------------------------------------------------------------------
_C.DATASET = CN()
_C.DATASET.root_dataset = "data/categories/ade20k/"
_C.DATASET.list_train = "data/categories/ade20k/training.odgt"
_C.DATASET.list_val = "data/categories/ade20k/validation.odgt"
...
_C.TEST.result = "data/outputs/sceneparse/"

_C.CATEGORIES = CN()
_C.CATEGORIES.colors = "data/categories/ade20k/color150.mat"
_C.CATEGORIES.names = "data/categories/ade20k/object150_info.csv"
